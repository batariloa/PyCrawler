...
class Crawler():
    ...
    def look_at_links_from_list(self, number_of_links, links_to_be_searched, search_phrase, result_handler):
    ...
    def look_for_links(self, search_phrase, depth_of_search, result_handler):
        ...
        try:
            search_results = self.look_at_links_from_list(
                depth_of_search, lista_linkova, search_phrase, result_handler)
